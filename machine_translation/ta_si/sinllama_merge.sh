...
TSV="$(dirname "$(readlink -f "$0")")/ta_si.tsv"
...
for run in "slerp-a03:${MODELS}/SinLlama-slerp-a03" \
  ...
  for qt in zero-shot zero-shot-si few-shot few-shot-si; do
    echo "==================================================================="
    echo " ${tag} | Ta->Si translation (TamSiPara tail-1000) | query_type=${qt}"
    echo "==================================================================="
...
echo "All merged-checkpoint zero/few-shot Ta->Si translation runs finished."